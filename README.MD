...
Diagnostics Model assumptions were evaluated using graphical diagnostics. 
...
- No evidence of influential outliers Overall, model assumptions were considered adequately satisfied. 
